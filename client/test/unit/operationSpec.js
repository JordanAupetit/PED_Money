describe('OperationTest', function() {
    ...
    describe('should success any functions', function() {
        ...
        beforeEach(inject(function(_$httpBackend_, $rootScope, $controller, initService, OperationResource, AccountResource, $state) {
            ...
            //$httpBackend.expect('GET', '/api/account').respond(200, account);
        ...
        it('test validate & update operation', function() {
            ...
            scope.validateOperation(scope.account.operations[0]);
            scope.updateOperation(scope.account.operations[0]);
